...
[![Version](https://img.shields.io/badge/version-8.8.6-blue?style=for-the-badge)](https://github.com/mstrvndev/auto-accept-agent-antigravity-free/releases)
...
2. Download the latest **`auto-accept-agent-8.8.6.vsix`** file.
